import { Body, Controller, Post, ValidationPipe, Get, Param, ParseIntPipe, Delete, Patch } from '@nestjs/common';
...
export class CommentController {
  ...
  @Patch(':id')
  async updateComment(@Param('id', ParseIntPipe) id: number, @Body(ValidationPipe) data: UpdateCommentDto){
